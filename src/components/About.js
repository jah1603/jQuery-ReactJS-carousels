...
const About = () => (
  <div className="about">
    ...
    <div className="about-paragraph">
      ...
      I recently graduated from <a href="https://codeclan.com/">CodeClan's</a> software development course in Edinburgh. Throughout the 16 week ct we woulund 8ree full-stack projects (you can check those out <a href="/portfolio" >here</a>). <br/><br/>
      ...
      Before CodeClan I completed a Master of Engineering degree in Naval Architecture, graduating with Merit. The analytical thinking techniques that I learned in my degree remain hugely beneficial when up against a new programming challenge. While I'm not programming I enjoy travelling, playing piano and guitar, playing squash, learning foreign languages and reading.</p>
    </div>
