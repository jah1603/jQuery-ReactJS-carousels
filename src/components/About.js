...
const About = () => (
  <div className="about">
    ...
    <div className="about-paragraph">
      ...
      I finished the course in September 2018 brimming with passion for the industry, equally so for front and back end and how they interact. I am constantly learning and pushing myself to deepen my knowledge, throwing myself into tough personal software projects for pure pleasure (see <a href="/portfolio" >here</a>).<br/><br/>
