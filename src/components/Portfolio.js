...
<div class="dialog">
  ...
  <video width="45%" controls>
    ...
    The app is built around a sleek and elegant front end designed to entertain users. Three APIs (Wikipedia, The Paleobiology Database and Google Maps) are used to fetch dinosaur data. Dinosaur data is initially presented in preview form in a scrolling address book-style view, with each clickable preview image leading to a page with more details. <span style={{fontStyle: 'italic'}}>Findasaur</span> also features a predictive search bar, the ability to favourite individual dinosaurs by era, allowing users to track the most interesting finds. <span style={{fontStyle: 'italic'}}>Findasaur</span> sourced additional data for 270 dinosaurs from the Natural History Museum website via scraping methods in Python. <br/><br/>
    </p>
