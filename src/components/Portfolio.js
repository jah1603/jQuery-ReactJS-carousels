...
class Portfolio extends React.Component {
  ...
  <div className="project-paragraph-findasaur">
    ...
    <p className="project-description">I set myself the target to make an app over the Christmas and New Year break in order to keep my programming skills sharp. Out of this came <span style={{fontStyle: 'italic'}}>Findasaur</span>, a ReactNative Android and iOS app designed to educate inquisitive young minds on the world of dinosaurs. <br/><br/>
